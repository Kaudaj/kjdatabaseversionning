...
final class CommitGridDefinitionFactory extends AbstractGridDefinitionFactory
{
    public const GRID_ID = 'commits';
    ...
    {
        return $this->trans('Commits', [], 'Modules.Kjdbvcs.Admin');
    }
    ...
    protected function getRowActions()
    {
        return (new RowActionCollection())
            ->add((new SubmitRowAction('delete'))
                ...
                ->setOptions([
                    'method' => 'DELETE',
                    'route' => 'kj_dbvcs_commit_delete',
                    'route_param_name' => 'commitId',
                    'route_param_field' => 'id_commit',
