...
$(() => {
  const changesGrid = new window.prestashop.component.Grid('changes');

  const gridExtensions = [
    new window.prestashop.component.GridExtensions.ExportToSqlManagerExtension(),
    new window.prestashop.component.GridExtensions.ReloadListExtension(),
  ...
  gridExtensions.forEach((extension) => {
    changesGrid.addExtension(extension);
  });
});
